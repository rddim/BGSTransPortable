...
user in an INI file next to BGSTransPortable.exe called BGSTransPortable.ini.
...
copy AppNamePortable.ini from this directory to BGSTransPortable.ini next to
BGSTransPortable.exe. The options in the INI file are as follows:
